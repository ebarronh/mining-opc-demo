...
export const DataFlowAnimator: React.FC<DataFlowAnimatorProps> = ({
  ...
  return (
    <div className={`relative w-full h-full overflow-hidden ${className}`}>
      ...
      {/* Help Info - moved to bottom right, made much smaller with hover tooltip */}
      <div className="absolute bottom-2 right-2 group">
        ...
        <div className="absolute bottom-full right-0 mb-2 w-96 p-4 bg-slate-900 border border-slate-600 rounded-lg text-xs text-slate-300 opacity-0 group-hover:opacity-100 transition-opacity z-50 pointer-events-none shadow-2xl">
